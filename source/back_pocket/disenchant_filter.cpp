...
public:
  static bool install() {
    ...
    // Back Pocket for Controller: main.cpp allocates one trampoline for this hook and the Y hold together - a
    // second AllocTrampoline here would replace the one the input hook already wrote into.
